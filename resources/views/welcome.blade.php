...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="container mx-auto my-10">
            ...
            <div class=" mb-5">
                <a href="#" class="font-medium text-gray-500 dark:text-white hover:underline">Download Excel Template</a>
            </div>
            <div class="mb-5">
                <div>
                    <input
            ...
            <div class="flex flex-row mt-7">
                <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded mr-5 w-1/2 rounded-xl">
                    Button
                </button>
